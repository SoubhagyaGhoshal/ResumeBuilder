...
const renderNewPage = () => `<div class="md-it-newpage"></div>`;
const renderLineBreak = (tokens, idx) =>
  `<div class="md-it-line-break" style="margin-top:${tokens[idx].meta.h};"></div>`;
const checkPattern = (state, start, pattern, options = {}) => {
...
const newPage = (state, start, end, silent) => {
...
const lineBreak = (state, start, end, silent) => {
  // Try to find "\\["
 ...
 */
export const MarkdownItLatexCmds = (md) => {
